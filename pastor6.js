          ...
          <div class="episode-card">
           ...
           <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">1.28 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~124 min</div>
                ...
                <a class="download-button" href="https://tpi.li/P45t0R9" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
           ...
           <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">690 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~62 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/P45t0R11" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>          
